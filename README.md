...
## Javascript Assignments  [![Build Status](https://travis-ci.org/ilidar228/js-assignments.svg?branch=master)](https://travis-ci.org/ilidar228/js-assignments)
...
* Edit local README.md file and update all links (just replace all occurrences of `'ilidar228'` with your account name).
...
```
* Open https://github.com/ilidar228/js-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
